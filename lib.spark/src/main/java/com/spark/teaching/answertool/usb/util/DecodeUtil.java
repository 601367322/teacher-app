...
import com.spark.teaching.answertool.usb.model.DeviceConfigureRep;
...
//                LogUtils.i(msg + "\n" + stringBuilder.toString(), false);
            ...
            case 0x95://开启刷卡绑卡指令响应
                ...
                break;
            case 0x13:
                DeviceConfigureRep deviceConfigureRep = new DeviceConfigureRep();
                deviceConfigureRep.decoding(data);
                msg = "查询答题器信息指令响应：" + deviceConfigureRep.toString();
                LogUtils.i(msg + "\n" + stringBuilder.toString(), false);
                break;
