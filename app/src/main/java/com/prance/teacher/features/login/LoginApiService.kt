...
interface LoginApiService {
    ...
    @GET("http://result.eolinker.com/FfBct6q9d9d994b38dc3c41b45b3cbb591fefab7c045a43?uri=http://api-shuangshi.dev.tengyue360.com/backend/user/app/login")
    fun checkQrCode(@Query("timestamp") timestamp: String, @Query("token") token: String): Flowable<UserEntity>
}