...
class ChooseKeyPadActivity : BaseActivity() {
    ...
    companion object {
        ...
        fun callingIntent(context: Context, list: DeleteKeyPadActivity.SerializableList<StudentEntity>, mClassesEntity: ClassVo, position: Int): Intent {
    ...
    override fun fragment(): BaseFragment = ChooseKeyPadFragment
            .forStudents(
                    intent.getSerializableExtra(STUDENTS) as DeleteKeyPadActivity.SerializableList<StudentEntity>,
