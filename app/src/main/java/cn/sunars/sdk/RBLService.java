...
public class RBLService extends Service {
	...
	public final static UUID UUID_BLE_DATA_SERVICE = UUID
			.fromString(RBLGattAttributes.BLE_DATA_SERVICE);
	public final static UUID UUID_BLE_COM_SERVICE = UUID
			.fromString(RBLGattAttributes.BLE_COM_SERVICE);
...
//		}
	...
	public boolean getSupportService() {
		if (mBluetoothGatt == null)
			return false;
		characteristicTx=mBluetoothGatt.getService(UUID_BLE_DATA_SERVICE).getCharacteristic(UUID_BLE_SHIELD_TX);
		characteristicRx=mBluetoothGatt.getService(UUID_BLE_COM_SERVICE).getCharacteristic(UUID_BLE_SHIELD_RX);
		if(characteristicRx != null){
			setCharacteristicNotification(characteristicRx,true);
			readCharacteristic(characteristicRx);
		}
		return characteristicTx != null && characteristicRx != null;
	}
