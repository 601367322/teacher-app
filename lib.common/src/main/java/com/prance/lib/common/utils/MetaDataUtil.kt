...
object MetaDataUtil {
     ...
     * @return the value of meta-data in activity
     */
    fun getMetaDataInActivity(activity: Activity,
                              key: String): String {
     ...
     * @return the value of meta-data in activity
     */
    fun getMetaDataInActivity(clz: Class<out Activity>,
                              key: String): String {
        var value = ""
        val pm = Utils.getApp().packageManager
     ...
     * @return the value of meta-data in service
     */
    fun getMetaDataInService(service: Service,
                             key: String): String {
     ...
     * @return the value of meta-data in service
     */
    fun getMetaDataInService(clz: Class<out Service>,
                             key: String): String {
        var value = ""
        val pm = Utils.getApp().packageManager
        val componentName = ComponentName(Utils.getApp(), clz)
     ...
     * @return the value of meta-data in receiver
     */
    fun getMetaDataInReceiver(receiver: BroadcastReceiver,
                              key: String): String {
     ...
     * @return the value of meta-data in receiver
     */
    fun getMetaDataInReceiver(clz: Class<out BroadcastReceiver>,
                              key: String): String {
        var value = ""
        val pm = Utils.getApp().packageManager
        val componentName = ComponentName(Utils.getApp(), clz)
