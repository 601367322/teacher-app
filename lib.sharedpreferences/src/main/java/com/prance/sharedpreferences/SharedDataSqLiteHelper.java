...
public class SharedDataSqLiteHelper {
    ...
    public static final String DB_NAME = "shared.db";
    ...
    public SharedDataSqLiteHelper(Context context, String dbName) {
     ...
     * @return
     */
    public List<SharedData> getAllData() {
        SharedData sharedData = null;
        String sql = "select * from " + SharedData.TABLE_NAME;
        Cursor cursor = null;
        List<SharedData> list = new ArrayList<>();
        try {
            cursor = sqLiteDatabase.rawQuery(sql, null);
